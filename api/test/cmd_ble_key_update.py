...
if access_token is not None:
	...
	params = {
		...
		'ble_key1': 1234567812345678123,
		'ble_key2': 1234567812345678123,
		'signature': 1,
	}

	try:
		url = 'http://localhost:7999/ble_key_update/'
		# url = 'http://localhost:7999/api/ble_key_update/'
